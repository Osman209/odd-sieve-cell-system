...
**(V, Theorem 4.)** So $R \lt  C$ — the inequality one wants — is precisely the statement that a **Liouville sum over the sifted set is negative**.
