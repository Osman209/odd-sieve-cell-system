...
That is the weakest form the twin statement takes anywhere in this work, and three measurements say the reduction is not paid for elsewhere. Over the $71$ such sectors below $M = 3000$ there are $7{,}818$ open cells and **not one fails to be a twin**, against $155$ non-twin survivors in the $428$ ordinary sectors of the same range. The survivor count itself is not depressed: the density in these five classes against all others is $0.934$ up to $M = 4000$, $0.997$ up to $12000$ and $1.000$ up to $30000$ — **fixing the phases of $5$ and $7$ changes which cells die, not how many.** And $C_M$ is nowhere near zero: its minimum over those sectors is $10$ below $M = 3000$ and $520$ for $M$ near $2\times10^4$, against $497$ in the ordinary classes.
